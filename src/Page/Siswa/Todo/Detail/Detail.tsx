      ...
      <div className="space-y-6">
          ...
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex items-center space-x-3">
              <button
                ...
                className="bg-gray-600 hover:bg-gray-700 text-white px-4 py-2 rounded-lg flex items-center space-x-2 transition-all duration-200 font-medium text-sm"
              >
              ...
              return (
                <div className={`mb-4 p-3 rounded-lg ${
                  ...
                  <p className={`text-sm mt-1 ${
                    ...
                    Deadline: {formatDate(task.batas_waktu)}
                  </p>
                </div>
              );
            })()}
        ...
        {task.status_tugas === 'Sudah Dinilai' && (
          <div className="bg-purple-500/10 border border-purple-500/20 rounded-xl p-6">
            ...
            <p className="text-purple-300 text-sm">Score: {task.nilai || 0}/100</p>
          </div>
        )}
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">
                      {selectedFile.type === 'task' ? 'Task File Content' : 'Answer File Content'}
                    </p>
                  </div>
                </div>
                <div className="flex items-center space-x-3">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-2 text-sm">
                      ...
                      <div>
                        ...
                        <span className="text-white ml-2">
                          {selectedFile.type === 'task' ? 'Task File' : 'Answer File'}
                        </span>
                      </div>
                    </div>
                  </div>
