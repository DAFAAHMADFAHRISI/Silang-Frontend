...
const Chat: React.FC = () => {
  ...
  useEffect(() => {
    if (selectedRoom) {
      localStorage.setItem('chat_selected_room', JSON.stringify(selectedRoom));
    } else {
      localStorage.removeItem('chat_selected_room');
    }
  }, [selectedRoom]);
    ...
    return (
      <div className="h-full flex items-center justify-center bg-gray-900">
        <div className="flex items-center space-x-3">
          ...
          <span className="text-white">Memuat chat...</span>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="h-full flex flex-col bg-gray-900">
      ...
      <div className="flex flex-1 overflow-hidden flex-row-reverse min-h-0">
        {/* Contacts Sidebar */}
        <div className={`
          ${showContacts ? 'fixed inset-y-0 right-0 z-50 w-full max-w-sm' : 'hidden'}
          lg:relative lg:inset-auto lg:z-auto lg:block lg:w-80
          ...
          <div className="p-4 border-b border-gray-700 space-y-3">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                aria-label="Tutup daftar kontak"
              >
                ✕
              </button>
            </div>
