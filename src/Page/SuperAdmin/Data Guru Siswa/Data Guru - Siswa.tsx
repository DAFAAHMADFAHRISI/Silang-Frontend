...
// Inline add/edit/detail logic moved to dedicated pages
  ...
  return (
      ...
      <div className="p-6">
        ...
        <div className="flex justify-between items-center mb-6">
          ...
          <div className="flex space-x-3">
            <button
              onClick={() => navigate('/DataGuruSiswa/tambah')}
                      ...
                      {students.map((student, index) => (
                        <div key={index} className="flex items-center justify-between text-sm mb-2 last:mb-0">
                          ...
                          <div className="flex space-x-1">
                            <button
                              onClick={() => navigate(`/DataGuruSiswa/detail/${student.id}`)}
                            ...
                            <button
                              onClick={() => navigate(`/DataGuruSiswa/edit/${student.id}`)}
        ...
        {/* Modals removed - using dedicated routes for detail/tambah/edit */}
      </div>
